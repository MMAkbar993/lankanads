...
import { LayoutDashboard, UserPlus, Users, Megaphone, X, UsersRound, Coins, FileText, Globe, Flag } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Reported Ads', href: '/dashboard/reports', icon: Flag },
];
